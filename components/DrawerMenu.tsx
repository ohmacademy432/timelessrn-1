    ...
    {rendered&&<View style={s.root} pointerEvents="auto">
      ...
      <Animated.View style={[s.drawer,{width:drawerWidth,transform:[{translateX:slide}]}]}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <MI l="Home" o={()=>go("/home")}/><MI l="Services" o={()=>go("/services")}/><MI l="Membership" o={()=>go("/membership")}/><MI l="Timeless RN" o={()=>go("/chat")}/><MI l="IV Therapy Pre-Screening" o={()=>{onClose();Linking.openURL("https://forms.gle/WzaPRFrgqk9rHTro7").catch(()=>{});}}/><MI l="NAD Pre-Screening" o={()=>{onClose();Linking.openURL("https://forms.gle/Wrdnz5DnvCSnBinQ6").catch(()=>{});}}/><MI l="Send Us a Message" o={()=>{onClose();Linking.openURL("sms:16159702015").catch(()=>{});}}/>
